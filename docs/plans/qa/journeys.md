...
Checkpoint 2026-09-08T18:46Z: P1-01 HTTP concurrency passed (`qa-evidence/P1-01/`). C06-OP walk-in cash passed (`qa-evidence/C06-OP/`). C06-CUS public menu and table reservation passed as separate paths (`qa-evidence/C06-CUS/`). Not a complete case. Do not record passes from skipped Playwright.
