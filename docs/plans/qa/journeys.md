...
Checkpoint 2026-09-08T18:33Z: P1-01 HTTP concurrency passed (`qa-evidence/P1-01/`). C06-OP walk-in cash passed (`qa-evidence/C06-OP/`). C06-CUS public menu passed (`qa-evidence/C06-CUS/`). Neither is a complete case. Do not record passes from skipped Playwright.
