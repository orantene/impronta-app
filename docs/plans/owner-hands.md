...
| 5 | Meta and TikTok developer sign-in | The Integration Director read the whole path, found three blockers and fixed the two in code (#1880, #1887); the apps need the owner's identity | DONE 2026-09-06: signed in; the Integration Director is creating both apps. Still yours: the four secret values (Instagram id and secret, TikTok key and secret) go into Vercel by your hand, never piped |
