...
Have: inquiries, quotes.

## Missing business behavior

Missing: quote version, variations, materials vs labour.
...
| Steps | Customer accepts a quote. Through the real website or profile. Refresh and reopen. |
...
| Negative / recovery | Balance reflects the variation. |
| Automated or manual | Playwright when fixture exists; until then not started |
| Evidence | `qa-evidence/C33-CUS/` |
...
### C33-OP — Operator journey

| Field | Value |
|---|---|
| Environment | Same fixture, staff or owner |
| Role | Operator |
| Steps | Operator records a variation. Workspace or POS. Sign out/in. Reopen the record. |
...
### C33-DIFF — Difficult combination

| Field | Value |
|---|---|
| Steps | Original quote stays identifiable. |
...
| Field | Value |
|---|---|
| Steps | Balance reflects the variation. |
