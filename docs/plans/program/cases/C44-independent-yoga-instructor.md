# C44 — Independent yoga instructor
...
Have: sessions, solo seller.

## Missing business behavior

Missing: teaching at a venue she does not own, packages.
...
| Steps | Student books her class. Through the real website or profile. Refresh and reopen. |
...
| Negative / recovery | Package decrements her own places. |
| Automated or manual | Playwright when fixture exists; until then not started |
| Evidence | `qa-evidence/C44-CUS/` |
...
### C44-OP — Operator journey

| Field | Value |
|---|---|
| Environment | Same fixture, staff or owner |
| Role | Operator |
| Steps | Instructor teaches at a partner studio. Workspace or POS. Sign out/in. Reopen the record. |
...
### C44-DIFF — Difficult combination

| Field | Value |
|---|---|
| Steps | Studio capacity stays the studio's. |
...
| Field | Value |
|---|---|
| Steps | Package decrements her own places. |
