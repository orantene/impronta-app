...
Have: sessions, inquiries, events.

## Missing business behavior

Missing: three modes over one kitchen.
...
| Steps | Customer enrols in a class. Through the real website or profile. Refresh and reopen. |
...
| Negative / recovery | Cancellation releases the kitchen. |
| Automated or manual | Playwright when fixture exists; until then not started |
| Evidence | `qa-evidence/C15-CUS/` |
...
### C15-OP — Operator journey

| Field | Value |
|---|---|
| Environment | Same fixture, staff or owner |
| Role | Operator |
| Steps | Operator books catering. Workspace or POS. Sign out/in. Reopen the record. |
...
### C15-DIFF — Difficult combination

| Field | Value |
|---|---|
| Steps | Kitchen capacity is shared. |
...
| Field | Value |
|---|---|
| Steps | Cancellation releases the kitchen. |
