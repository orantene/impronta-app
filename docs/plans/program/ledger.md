...
| P0-06 | mixed | awaiting external verification | cloud-agent | 2026-09-08T17:15Z | cursor/journeys-program-c4d3 | SQL fixture + 5 auth users on qa-journeys. `JOURNEYS_FIXTURE_READY` unset. Do not seed Impronta. |
...
| P1-01 | local-only | awaiting external verification | cloud-agent | 2026-09-08T17:15Z | cursor/journeys-program-c4d3 | `reserve_capacity` repaired on qa-journeys. Sequential 12-seat smoke passed and released. 200-caller HTTP proof still needs `service_role`. Never production. |
