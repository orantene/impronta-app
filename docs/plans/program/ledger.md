...
| P3-05 | cloud-safe | implemented, awaiting focused verification | cloud-agent | 2026-09-08T12:15Z | cursor/journeys-program-c4d3 | `sessionId` on addLine. Collect holds the offering pool (and session window) via `holdDraftOrderCapacity`; line edits still do not. Split collect does not hold twice. |
