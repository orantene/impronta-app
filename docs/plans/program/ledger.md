...
| P5-01 | mixed | implemented, awaiting focused verification | cloud-agent | 2026-09-08T22:09Z | cursor/journeys-program-c4d3 | C07-OP browser: Open tab vs Open visit, unpaid Close refused, cash then Close (`qa-evidence/C07-OP/collect-at-close.md`). Guest tab / booth not run. |
