...
| W-AUDIT | Standing — tenant check on capacity pool IDs. Isolation proofs: POS, visits (including guest token / QR / floor), hybrid cancel, prep. Continues. |
