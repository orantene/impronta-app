...
| W-AUDIT | Standing — tenant check on capacity pool IDs (purchase path refuses before RPC). Isolation: POS, visits (token/QR/floor), hybrid cancel, prep, shifts. Collect holds class places before money. Continues. |
