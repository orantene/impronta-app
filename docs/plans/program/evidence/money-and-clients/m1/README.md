...
- Branch: `feat/mc-m1-definitions-read-model`
- Base: `origin/main` @ `2bb8b3ef1` (rebased 2026-09-25 after Structural flake + conflicts)
- A4 #2274 included; `COLORS`/`FONTS` kept for `MoneyLoadError`; `test:money` takes main lane + M1 tests
