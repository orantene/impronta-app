...
D-POS-82). Seat sheet: Server, No-show.
...
engine's `waitlist_offers` is the session hold (D-POS-68, D-POS-89), wired on
the Front desk (see `fidelity-appts`). Decisions D-POS-82, D-POS-90.
