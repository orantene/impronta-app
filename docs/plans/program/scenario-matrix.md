...
| C06 | C06-CUS | Restaurant | not started | `qa-evidence/C06-CUS/` |
| C06 | C06-OP | Restaurant | not started | `qa-evidence/C06-OP/` |
...
| C07 | C07-OP | Bar | not started | `qa-evidence/C07-OP/` |
...
| C08 | C08-CUS | Modelling or talent agency | not started | `qa-evidence/C08-CUS/` |
...
| C09 | C09-OP | Yoga or fitness studio | not started | `qa-evidence/C09-OP/` |
...
| C12 | C12-CUS | Event venue | not started | `qa-evidence/C12-CUS/` |
