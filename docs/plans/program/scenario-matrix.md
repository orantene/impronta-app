...
| 3.6 | WIRE-3.6 | Guest QR browse / add / submit / share / bill | passed — rerun 2026-09-16 r8, host a34c99214 (D-141, D-149 fixed): browse → add → submit → kitchen ticket → pay my share → second share refused | `e2e/cases/WIRE-3-guest-qr.spec.ts` · `docs/plans/program/evidence/wiring-verify/2026-09-16/logs/` |
...
| 3.8 | WIRE-3.8 | Exchange / comp / multi-day / delivery | passed — rerun 2026-09-16 r7, host a34c99214 (D-142, D-146 fixed): comp, exchange, print | `e2e/cases/WIRE-3-exchange-comp.spec.ts` · `docs/plans/program/evidence/wiring-verify/2026-09-16/logs/` |
| 3.9 | WIRE-3.9 | Ticket page transfer / resend / lookup | failed-app (D-153) — rerun 2026-09-16 r7, host a34c99214: the public ticket page passes end to end (D-141, D-148 fixed); at the gate the old code is typed and Admit pressed, and no verdict renders (`[data-door-verdict='superseded']` never appears; the gate stays "Ready to scan") | `e2e/cases/WIRE-3-ticket-page.spec.ts` · `docs/plans/program/evidence/wiring-verify/2026-09-16/logs/` |
...
| 4.6 | WIRE-4.6 | Customer thread /c/t/<token> | failed-app (D-150, view half; PR #2004) — rerun 2026-09-16 r7, host a34c99214: the page computes the thread link, the expired view did not render it | `e2e/cases/WIRE-4-customer-thread.spec.ts` · `docs/plans/program/evidence/wiring-verify/2026-09-16/logs/` |
