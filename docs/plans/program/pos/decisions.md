...
## D-POS-58 — Settings › POS, Payments & providers, Locations and Booking policies: what is drawn and what is disabled
...
## D-POS-59 — Sales, Payments and the first-run setup page: filters, imports and exports without a reader are disabled
