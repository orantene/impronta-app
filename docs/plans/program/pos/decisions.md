...
## D-POS-35 — a project has no owner and no blank "New project"; both are drawn disabled
...
## D-POS-36 — no reminder is sent from a project; "Request approval" and "Remind" are disabled
