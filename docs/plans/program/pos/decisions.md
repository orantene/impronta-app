...
## D-POS-44 — passes, memberships and gift cards are drawn disabled behind one sentence
...
## D-POS-45 — one catalog per workspace; location is a chip disabled with its reason
...
## D-POS-46 — preparation, fulfillment, photos and tables sections have no column on an item
