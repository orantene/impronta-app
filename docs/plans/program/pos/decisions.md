...
## D-POS-11 — the POS switch keeps the modes' own labels for now
...
## D-POS-12 — search never carries a per-client balance
...
## D-POS-13 — an assistant sees the union of the three staff rails
