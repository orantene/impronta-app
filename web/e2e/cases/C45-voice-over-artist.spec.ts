...
test("C45-CUS smoke: storefront body is reachable — not a journey pass", async ({ page }) => {
  await openStorefront(page);
});

test("C45-OP smoke: operator Sales heading is reachable — not a journey pass", async ({ page }) => {
