...
export const PROBE_TABLES: FloorTable[] = [
  {
    ...
    visitVersion: 1,
    openedAtIso: "2026-09-11T01:30:00.000Z",
    publicToken: "tok",
    orderId: "00000000-0000-4000-8000-0000000000b1",
    orderIds: ["00000000-0000-4000-8000-0000000000b1"],
    checks: [{ orderId: "00000000-0000-4000-8000-0000000000b1", totalCents: 0 }],
    orderTotalCents: 0,
    serverUserId: null,
...
export const PROBE_TICKETS: PrepTicketView[] = [
  {
    ...
    tableCode: "T1",
    partySize: 2,
    submittedAt: "2026-09-11T01:35:00.000Z",
    acknowledgedAt: null,
    readyAt: null,
