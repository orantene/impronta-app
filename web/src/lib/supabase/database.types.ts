 ...
 *
 * Canonical TypeScript types for the public Supabase schema. Generated by the
 * Supabase CLI; regenerate from the canonical remote schema with:
 *
 *   npx -y supabase@latest gen types typescript \
 *     --project-id pluhdapdnuiulvxmyspd \
 *     > web/src/lib/supabase/database.types.ts
 *
 * `SUPABASE_ACCESS_TOKEN` must be set (e.g. via `web/.env.local`). The remote
 * project ref `pluhdapdnuiulvxmyspd` matches the production Supabase project
 * documented in `CLAUDE.md` and the `NEXT_PUBLIC_SUPABASE_URL` env var.
 *
 * Wire-up notes (T2b / Phase A — 2026-05-19):
 *   - This file is the new canonical source of types for the Supabase schema.
 *     The app-wide Supabase clients (lib/supabase/{client,server,admin,
 *     middleware,public}.ts) still construct untyped `SupabaseClient`
 *     instances, so `Database` is not yet enforced end-to-end. New code and
 *     T2b/Phase C migrations may opt in by parameterising the client OR by
 *     consuming the row/insert/update types directly, e.g.:
 *
 *       import type { Database } from "@/lib/supabase/database.types";
 *       type InquiryRow = Database["public"]["Tables"]["inquiries"]["Row"];
 *
 *   - The file is ~12k lines — it is added to `globalIgnores` in
 *     `web/eslint.config.mjs` so it does not need a `max-lines` suppression
 *     and does not contribute to the suppressions baseline.
 *
 *   - 109 tables in `public` carry a `tenant_id` column (Phase C candidates
 *     for `tenantScopedQuery`); 50 do NOT (e.g. `agencies`, `profiles`,
 *     `talent_profiles`, `field_values`, reference tables) — those `.from()`
 *     callsites are retained-with-reason; see
 *     `web/docs/t2b-site-inventory-2026-05-19.md` for the full classification.
 */
...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      agency_talent_roster_dropped_cols_archive_20261023: {
        Row: {
          emergency_contact: Json | null
          field_locks_data: Json | null
          id: string | null
          internal_notes: string | null
      ...
      coordinator_join_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "coordinator_join_requests_inquiry_id_fkey"
            columns: ["inquiry_id"]
            isOneToOne: false
            referencedRelation: "inquiries"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "coordinator_join_requests_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "agencies"
            referencedColumns: ["id"]
      ...
      field_definitions_archived_20260611: {
        Row: {
          active: boolean | null
          ...
          config: Json | null
          created_at: string | null
          directory_filter_sort_order: number | null
          directory_filter_visible: boolean | null
          editable_by_admin: boolean | null
          editable_by_staff: boolean | null
          editable_by_talent: boolean | null
          ...
          preview_visible: boolean | null
          profile_visible: boolean | null
          public_visible: boolean | null
          required_level:
            | Database["public"]["Enums"]["field_required_level"]
            | null
          searchable: boolean | null
          sort_order: number | null
          taxonomy_kind: Database["public"]["Enums"]["taxonomy_kind"] | null
          tenant_id: string | null
          updated_at: string | null
          value_type: Database["public"]["Enums"]["field_value_type"] | null
        }
        Insert: {
          active?: boolean | null
          ai_visible?: boolean | null
      ...
      field_values_archived_20260611: {
        Row: {
          created_at: string | null
      ...
      inquiries: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["current_offer_id"]
            isOneToOne: false
            referencedRelation: "inquiry_offers_client_view"
            referencedColumns: ["id"]
          },
          {
      ...
      talent_profiles_dropped_cols_archive_20261023: {
        Row: {
          ...
          media_albums_data: Json | null
          package_rates_data: Json | null
          passport_status: string | null
          personality_traits: Json | null
          pronouns: string | null
          pronouns_custom: string | null
          rate_card_visibility: string | null
          rate_tiers_data: Json | null
          rates_data: Json | null
          response_time: string | null
          social_proof_data: Json | null
          tagline: string | null
          travel_included: boolean | null
          upcoming_visits: Json | null
    ...
    Views: {
      inquiry_offer_line_items_client_view: {
        Row: {
          created_at: string | null
          id: string | null
          label: string | null
      ...
      inquiry_offers_client_view: {
        Row: {
          ...
          notes: string | null
          sent_at: string | null
          status: Database["public"]["Enums"]["inquiry_offer_status"] | null
    ...
    Functions: {
      ...
      coord_request_approve: {
        Args: { p_request_id: string }
        Returns: undefined
      }
      coord_request_can_approve: {
        Args: { p_inquiry_id: string; p_user_id: string }
        Returns: boolean
      }
      coord_request_cancel: {
        Args: { p_request_id: string }
        Returns: undefined
      }
      coord_request_decline: {
        Args: { p_reason?: string; p_request_id: string }
        Returns: undefined
      }
      coord_request_revoke: {
        Args: { p_reason?: string; p_request_id: string }
        Returns: undefined
      }
      coord_request_submit: {
        Args: { p_inquiry_id: string; p_pitch?: string }
        Returns: string
      }
