    ...
    Tables: {
      ...
      field_definitions: {
        Row: {
          ...
          config: Json
          created_at: string
          directory_filter_sort_order: number
          ...
          required_level: Database["public"]["Enums"]["field_required_level"]
          searchable: boolean
          sort_order: number
          taxonomy_kind: Database["public"]["Enums"]["taxonomy_kind"] | null
          tenant_id: string | null
          updated_at: string
          value_type: Database["public"]["Enums"]["field_value_type"]
        }
        Insert: {
          active?: boolean
          ai_visible?: boolean
      ...
      field_values: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "field_values_talent_profile_id_fkey"
            columns: ["talent_profile_id"]
            isOneToOne: false
            referencedRelation: "talent_discover_index"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      engine_persist_booking_commission_snapshot: {
        Args: {
          ...
          p_off_platform_reason: string
          p_payment_method: string
          p_platform_fee_cents: number
          p_platform_take_bps: number
          p_platform_take_floor_cents: number
          p_resolved_from: string
          p_talent_net_cents: number
          p_workspace_fee_cents: number
        }
        Returns: Json
      }
