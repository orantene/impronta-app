...
// +24 (2026-08-21): the reveal-hidden canvas marker effect (data-bn-reveal-hidden)
  ...
  // Three new rail segments land compiler-/nav-required lines in fixtures.ts,
  // each a mandatory +1/-0 (raise not extract, same as the Orders line above):
  //   +1 Reservations — PAGE_META entry (Record<WorkspacePage>)
  ...
  "src/components/admin/shell/internal/drawers/profile-shell/TalentProfileShellDrawer.tsx": 4789,
  ...
  "src/components/admin/shell/internal/media-page.tsx": 2832,
