...
export function MagazineLayoutComponent({
  props,
  sectionId,
  builderNodeBindings,
}: SectionComponentProps<MagazineLayoutV1>) {
  const { eyebrow, headline, hero, secondary, nodePresentation, presentation } = props;
