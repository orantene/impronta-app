  ...
  const value: PricingGridV1 = {
    ...
    plans:
      ...
      [
        ...
        { name: "Destination", price: "Custom", cadence: "scoped per trip", features: ["Trial + planning call", "Full multi-day", "International logistics"], ctaLabel: "Talk to us", ctaHref: "/directory", highlighted: false },
      ],
