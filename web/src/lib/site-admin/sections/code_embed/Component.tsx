...
export function CodeEmbedComponent({
  ...
  sectionId,
  builderNodeBindings,
}: SectionComponentProps<CodeEmbedV1>) {
  const { eyebrow, headline, caption, url, ratio, title, nodePresentation, presentation } = props;
