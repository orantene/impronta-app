...
export function GalleryStripComponent({
  ...
  const { eyebrow, headline, items, variant, caption, presentation, nodePresentation } = props;
  ...
  const responsiveCss = buildNodePresentationResponsiveCss({
    ...
    rules: [
      ...
      {
        selector: ".site-gallery__caption",
  ...
  return (
    ...
    >
      ...
      <Container width="standard">
        ...
        {caption ? (
          <p
            className="site-gallery__caption"
            ...
            style={{
              ...
              paddingRight:
                typeof copyNode?.paddingRightPx === "number"
                  ...
                  : undefined,
              fontSize: captionSize(copyNode?.size),
