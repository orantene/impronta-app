      ...
      steps: [
        {
          ...
          detail: "Share your event, dates, location, and the kind of talent you need.",
        },
        {
          label: "We shortlist options",
          detail: "Our team builds a focused shortlist of available, agency-approved talent.",
        },
        {
          label: "Confirm talent",
          detail: "Review profiles, ask questions, and confirm your selection.",
        },
        {
          label: "Coordinate the booking",
          detail: "We handle scheduling, logistics, and on-the-ground coordination.",
        },
      ],
      ...
      items: [
        {
          ...
          detail: "Every profile is reviewed and represented by the agency.",
        },
        {
          numberLabel: "02",
          title: "Local coordination",
          detail: "On-the-ground support across destination markets.",
        },
        {
          numberLabel: "03",
          title: "Booking support",
          detail: "Scheduling, logistics, and communication from brief to wrap.",
        },
      ],
