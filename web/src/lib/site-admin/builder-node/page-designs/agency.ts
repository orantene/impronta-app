...
const dataSources: BuilderNodeRenderDataSources = {
  collections: {
    agency_work: [
      { id: "w1", imageUrl: pageDesignPhoto("studioScene"), title: "At Home, On Air", client: "Tulala Originals", discipline: "Film + Sound" },
      { id: "w2", imageUrl: pageDesignPhoto("directorPortrait"), title: "The Direction Issue", client: "Atelier North", discipline: "Creative Direction" },
      { id: "w3", imageUrl: pageDesignPhoto("vocalistPortrait"), title: "Sessions", client: "Independent Artists", discipline: "Music + Performance" },
      { id: "w4", imageUrl: pageDesignPhoto("serviceProsScene"), title: "The Service Issue", client: "Casa Muna", discipline: "Campaign + Editorial" },
      { id: "w5", imageUrl: pageDesignPhoto("studioDesk"), title: "Studio Notes", client: "In-House", discipline: "Brand + Web" },
    ],
  },
};
...
export const agencyDesign: PageDesign = {
  id: "agency",
