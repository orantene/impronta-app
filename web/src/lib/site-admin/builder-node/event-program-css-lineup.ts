...
[data-event-program] .ep-tile-link:focus-visible{outline:2px solid var(--token-color-primary);outline-offset:3px}
...
[data-event-program] .ep-tile-title{font-size:0.7rem;font-weight:600;letter-spacing:0.14em;text-transform:uppercase;color:var(--token-color-muted)}
