...
function createHeading(text: string, level: 1 | 2 | 3 | 4 = 2): BuilderNode {
  return {
    id: makeId("heading"),
    kind: "heading",
    props: { text, level },
...
function createParagraph(text: string): BuilderNode {
  return {
    id: makeId("paragraph"),
    kind: "paragraph",
    props: { text },
...
function createButton(
  ...
  return {
    id: makeId("button"),
    kind: "button",
    props: { label, href, tone },
  };
}

function createImage(index = 0): BuilderNode {
