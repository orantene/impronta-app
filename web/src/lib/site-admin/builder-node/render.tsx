...
.site-builder-node--talent-type-grid-eyebrow{margin:0;font-size:0.75rem;font-weight:600;letter-spacing:0.16em;text-transform:uppercase;color:color-mix(in srgb,var(--token-color-ink,#111) 58%,transparent)}
...
.site-builder-node--talent-type-grid-intro{margin:0;max-width:60ch;color:color-mix(in srgb,var(--token-color-ink,#111) 68%,transparent);line-height:1.5}
...
.site-builder-node--talent-type-card-desc{font-size:0.85rem;line-height:1.4;color:color-mix(in srgb,var(--token-color-ink,#111) 62%,transparent)}
.site-builder-node--talent-type-card-count{font-size:0.8rem;color:color-mix(in srgb,var(--token-color-ink,#111) 50%,transparent)}
.site-builder-node--talent-type-grid-empty{width:100%;padding:1.5rem;text-align:center;color:color-mix(in srgb,var(--token-color-ink,#111) 58%,transparent);border:1px dashed color-mix(in srgb,var(--token-color-ink,#111) 22%,transparent)}
...
.site-builder-node--p2a-eyebrow{margin:0;font-size:0.75rem;font-weight:600;letter-spacing:0.16em;text-transform:uppercase;color:color-mix(in srgb,var(--token-color-ink,#111) 58%,transparent)}
...
.site-builder-node--p2a-copy{margin:0;max-width:60ch;color:color-mix(in srgb,var(--token-color-ink,#111) 68%,transparent);line-height:1.5}
.site-builder-node--p2a-empty{margin:0;width:100%;padding:1.5rem;text-align:center;color:color-mix(in srgb,var(--token-color-ink,#111) 58%,transparent);border:1px dashed color-mix(in srgb,var(--token-color-ink,#111) 22%,transparent)}
...
.site-builder-node--location-map-canvas{position:relative;background:radial-gradient(circle at 1px 1px,color-mix(in srgb,var(--token-color-ink,#111) 16%,transparent) 1px,transparent 0) 0 0/18px 18px,var(--token-color-surface,#f6f5f3)}
...
.site-builder-node--location-map-city-link{display:flex;flex-direction:column;gap:0.15rem;padding:0.75rem 0.9rem;border:1px solid color-mix(in srgb,var(--token-color-ink,#111) 14%,transparent);color:inherit;text-decoration:none}
.site-builder-node--location-map-city-name{font-weight:600}
.site-builder-node--location-map-city-region,.site-builder-node--location-map-city-count{font-size:0.82rem;color:color-mix(in srgb,var(--token-color-ink,#111) 55%,transparent)}
.site-builder-node--location-map-city-soon{font-size:0.72rem;letter-spacing:0.1em;text-transform:uppercase;color:color-mix(in srgb,var(--token-color-ink,#111) 45%,transparent)}
