 ...
 *
 * LIB-SIDE HALF. The editor-facing axes (layer-tree label, props panel) live in
 * `components/edit-chrome/gallery-native-kind-editor-registration.test.ts`,
 * because `lib/site-admin` may not import `components/edit-chrome` — a boundary
 * this file's first draft broke. The guard was worth having; being the
 * exception to a layering rule was not.
 *
 * WHY THIS EXISTS
 * ───────────────
