...
export const RESPONSIVE_PLUMBED_KEYS: ReadonlySet<string> = new Set([
  ...
  "backgroundImage", "backgroundLayers", "backgroundPosition", "backgroundRepeat",
  ...
  "justifyContent", "left", "letterSpacing", "lineClamp", "lineHeight", "marginBottom",
  ...
  "scrollSnapAlign", "scrollSnapType", "size", "stickyAnchor", "stickyOffset",
  "textColor", "textDecoration",
  "textShadow", "textStroke",   "textTransform", "tone", "top",
  "transformOrigin", "transitionDelay", "transitionDuration",
  "transitionProperty", "transitionTimingFunction", "translate",
  "userSelect", "visibility", "width",
  "zIndex",
]);
