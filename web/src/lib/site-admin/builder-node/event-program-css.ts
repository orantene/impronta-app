 ...
 *     from 640px, `[time 64px][rail 20px][content]` on phones (thumb hidden);
 ...
 * `cards` and `compact` share the tokens and the row anatomy.
 */
export const EP_CSS = `
...
[data-event-program] .ep-chip{flex:0 0 auto;min-height:44px;padding:0.55rem 1.1rem;border:1px solid var(--token-color-line);border-radius:999px;background:transparent;color:var(--token-color-ink);font-family:inherit;font-size:0.7rem;font-weight:600;letter-spacing:0.14em;text-transform:uppercase;white-space:nowrap;cursor:pointer;transition:border-color 160ms ease,background-color 160ms ease,color 160ms ease}
...
[data-event-program] .ep-cover{display:none;grid-column:4;width:72px;height:72px;object-fit:cover;border-radius:4px;background:var(--ep-primary-12)}
[data-event-program][data-ep-layout="timeline"] .ep-list::before{content:"";position:absolute;top:0;bottom:0;left:calc(64px + 0.75rem + 10px);width:1px;background:var(--ep-rail)}
[data-event-program][data-ep-layout="cards"] .ep-list{display:grid;grid-template-columns:1fr;gap:1rem}
[data-event-program][data-ep-layout="cards"] .ep-item{grid-template-columns:20px minmax(0,1fr);padding:1.25rem 0 0;border-top:1px solid var(--ep-rail);border-bottom:0}
[data-event-program][data-ep-layout="cards"] .ep-dot{grid-column:1}
[data-event-program][data-ep-layout="cards"] .ep-time{grid-column:2;flex-direction:row;align-items:baseline;gap:0.5rem;font-size:1rem}
[data-event-program][data-ep-layout="cards"] .ep-body{grid-column:2}
[data-event-program][data-ep-layout="cards"] .ep-cover{display:block;grid-column:2;width:100%;height:auto;aspect-ratio:4/3;margin-top:0.75rem}
[data-event-program][data-ep-layout="compact"] .ep-item{padding:0.65rem 0}
[data-event-program][data-ep-layout="compact"] .ep-title{font-size:1rem}
[data-event-program][data-ep-layout="compact"] .ep-desc,[data-event-program][data-ep-layout="compact"] .ep-subtitle{display:none}
@media (min-width:640px){[data-event-program] .ep-item{grid-template-columns:96px 24px minmax(0,1fr);padding:1.25rem 0}[data-event-program] .ep-item[data-image="1"]{grid-template-columns:96px 24px minmax(0,1fr) 72px}[data-event-program] .ep-cover{display:block}[data-event-program] .ep-title{font-size:1.3rem}[data-event-program][data-ep-layout="timeline"] .ep-list::before{left:calc(96px + 0.75rem + 12px)}[data-event-program] .ep-nav{margin:0;padding:0.5rem 0}[data-event-program][data-ep-layout="cards"] .ep-list{grid-template-columns:repeat(3,minmax(0,1fr))}}
