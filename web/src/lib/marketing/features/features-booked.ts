...

  {
    ...
    en: {
      ...
      popup: [
        ...
        [
          "Deposits end the no show problem, and the reservation lands on the same calendar and in the same inbox as everything else.",
        ],
      ],
      intro: [
        [
          "Reservation marketplaces charge you to reach guests who were already looking for you, then keep the relationship. Your own booking page keeps both the guest and the margin.",
        ],
      ],
      sections: [
        {
          ...
          body: [
            [
              "Party size, service windows and turn times decide what is actually available, so the page never offers a table for six that does not exist at eight o'clock.",
            ],
          ],
        },
        {
          ...
          body: [
            [
              "Under the surface this is ",
              { f: "appointments", label: "appointments" },
              " with a floor plan on top: the same deposits, the same reminders, the same inbox. That is why it can arrive quickly and behave predictably.",
            ],
          ],
        },
      ],
      highlights: [
        ...
        "Reservations on your own website",
        "Shared calendar and inbox",
      ],
      faq: [
        {
        ...
        },
        {
          ...
          a: "Not on day one. Most restaurants start by taking their own direct bookings here, where there is no commission on a guest who already knows them.",
        },
      ],
    },
    es: {
      ...
      popup: [
        ...
        [
          "Los anticipos acaban con el problema de las ausencias, y la reservación llega al mismo calendario y a la misma bandeja que todo lo demás.",
        ],
      ],
      intro: [
        [
          "Los marketplaces de reservaciones te cobran por llegar a comensales que ya te estaban buscando, y luego se quedan con la relación. Tu propia página de reservas conserva al comensal y el margen.",
        ],
      ],
      sections: [
        {
          ...
          body: [
            [
              "El número de personas, los horarios de servicio y los tiempos de mesa deciden qué hay disponible de verdad, así que la página nunca ofrece una mesa para seis que no existe a las ocho.",
            ],
          ],
        },
        {
          ...
          body: [
            [
              ...
              " con un plano de mesas encima: los mismos anticipos, los mismos recordatorios, la misma bandeja. Por eso puede llegar pronto y comportarse de forma predecible.",
            ],
          ],
        },
      ],
      highlights: [
        ...
        "Reservaciones en tu propio sitio",
        "Calendario y bandeja compartidos",
      ],
      faq: [
        {
        ...
        },
        {
          ...
          a: "El primer día no. La mayoría de los restaurantes empieza tomando aquí sus reservas directas, donde no hay comisión por un comensal que ya los conocía.",
        },
      ],
    },
  },
