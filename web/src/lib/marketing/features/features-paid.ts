...
export const PAID_FEATURES: Feature[] = [
...

  {
    ...
    en: {
      ...
      subtitle:
        "Capacity limits, QR passes on every ticket and scanning at the door. Your event, your page, your money.",
      ...
      popup: [
        ...
        [
          ...
          " you scan at the door, and the money moves on ",
      ...
      intro: [
        [
          "Ticketing platforms take a cut of every ticket and put their brand on your event. The audience becomes theirs, and next time you pay again to reach the people who already came.",
        ],
      ],
      sections: [
        {
          ...
          body: [
            [
              ...
              " as the rest of your site, so it looks like you and it lives on your domain.",
            ],
          ],
        },
        {
          ...
          body: [
            [
              "Set how many can come, sell until it is full, and scan passes on the way in so the list at the door matches what was actually sold.",
            ],
          ],
        },
      ],
      highlights: [
        ...
        "Capacity limits and ticket types",
        "QR pass on every ticket",
        "Scan at the door",
      ...
      faq: [
        ...
        {
          q: "How will the fees compare?",
          a: "The intention is the same platform fee as other booked work rather than a separate ticketing rate. Exact terms will be published before it ships.",
        },
      ],
    },
    es: {
      ...
      subtitle:
        "Límites de cupo, pase QR en cada boleto y escaneo en la puerta. Tu evento, tu página, tu dinero.",
      ...
      intro: [
        [
          "Las plataformas de boletos se llevan una parte de cada entrada y ponen su marca en tu evento. El público se vuelve suyo, y la próxima vez pagas otra vez para llegar a la gente que ya fue.",
        ],
      ],
      sections: [
        {
          ...
          body: [
            [
              ...
              " que el resto de tu sitio, así que se ve como tú y vive en tu dominio.",
            ],
          ],
        },
        {
          ...
          body: [
            [
              "Define cuánta gente cabe, vende hasta llenarlo y escanea los pases en la entrada para que la lista en la puerta coincida con lo que de verdad se vendió.",
            ],
          ],
        },
      ],
      highlights: [
        ...
        "Límites de cupo y tipos de boleto",
        "Pase QR en cada boleto",
        "Escaneo en la puerta",
        "El dinero a tu propia cuenta",
      ],
      faq: [
        {
        ...
        {
          q: "¿Cómo serán las comisiones?",
          a: "La intención es aplicar la misma comisión de plataforma que al resto del trabajo reservado, en lugar de una tarifa aparte para boletos. Los términos exactos se publicarán antes del lanzamiento.",
        },
      ],
    },
  },
