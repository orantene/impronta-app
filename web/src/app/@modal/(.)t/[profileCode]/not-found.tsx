  ...
  return (
    <div className="fixed inset-0 z-[120]">
      ...
      <div
        ...
        className="fixed inset-0 flex flex-col items-center justify-center gap-4 p-8 text-center sm:inset-x-1/2 sm:inset-y-4 sm:w-[min(560px,calc(100vw-3rem))] sm:-translate-x-1/2 sm:rounded-2xl sm:border sm:shadow-[0_40px_120px_-24px_rgba(0,0,0,0.45)]"
        style={{
      ...
      >
        ...
        <Link
          href="/directory"
          className="mt-2 inline-flex h-10 items-center rounded-full border px-5 text-[12px] font-semibold uppercase tracking-[0.16em] transition-colors hover:opacity-70"
