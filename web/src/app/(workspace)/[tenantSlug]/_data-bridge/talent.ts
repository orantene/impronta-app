...
// `_data-bridge/talent-inquiries-all-agencies.ts` so this file stays under
// the 800-line cap. Re-exported from the barrel at the bottom of the file
// so existing imports (`_data-bridge/talent` and `_data-bridge`) keep
...
// Cross-agency unified inbox loader lives in talent-inquiries-all-agencies.ts
// (extracted to keep this file under the 800-line lint cap). Re-exporting here
// preserves the existing `from "./talent"` import surface for all callers.
export {
  loadTalentInquiriesAllAgencies,
  type TalentInquiryAllAgenciesRow,
} from "./talent-inquiries-all-agencies";
