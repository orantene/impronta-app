...
// Client Messages route-segment error boundary.
//
// Catches errors thrown during server render of the Client Messages page
// (loadClientInquiries, loadInquiryMessages, loadClientInquiryDetails, etc.)
// or from within the ClientMessagesShell client component. Recovery is a
