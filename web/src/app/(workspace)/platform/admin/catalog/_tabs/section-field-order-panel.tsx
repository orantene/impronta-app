...
// Drag-to-reorder panel for the FIELDS within one profile-editor section.
// Posts ordered_ids (JSON) to reorderSectionFieldsAction. Modelled on
// field-order-panel.tsx and editor-section-reorder-panel.tsx.
...
export function SectionFieldOrderPanel({
  fields,
}: {
  fields: ReorderField[];
}) {
  ...
  return (
    <form
      action={reorderSectionFieldsAction}
      style={{
        display: "grid",
        gap: 8,
        marginBottom: 10,
