...
import type { SectionRevisionRow } from "@/lib/site-admin/server/sections";

import {
  restoreSectionRevisionAction,
...
function kindLabel(kind: SectionRevisionRow["kind"]): string {
  switch (kind) {
    case "published":
      return "publish";
    case "rollback":
...
export function SectionRevisionHistory({
  ...
  revisions: SectionRevisionRow[];
  canEdit: boolean;
}) {
  const [state, action, pending] = useActionState<
    SectionActionState,
    FormData
  >(restoreSectionRevisionAction, undefined);
