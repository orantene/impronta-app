...
export default function AdminInquiriesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[admin/inquiries/error.tsx]", error.message, error.stack);
  }, [error]);

  return (
    <div className="mx-auto max-w-2xl space-y-4 rounded-lg border border-destructive/40 bg-destructive/10 p-6">
      <h2 className="font-semibold text-destructive">Inquiry admin error</h2>
