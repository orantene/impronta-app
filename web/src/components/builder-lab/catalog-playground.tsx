...
// `isShellKind` is re-exported for external callers (catalog-governance.test.ts)
// now that it lives in playground-shared.ts.
export { isShellKind } from "./playground-shared";
