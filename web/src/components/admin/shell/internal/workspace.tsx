...
// Extracted to `./keyboard-layer` so the shell can import the two hooks
// without carrying this drawer; re-exported here for existing importers.
export { useKeyboardLayer, ShortcutHelpOverlay, type KeyboardLayerHandlers } from "./keyboard-layer";
