...
export function AppointmentsPage() {
  ...
  return (
    <div
      ...
      className={`-mx-[28px] -mt-[24px] -mb-[60px] grid min-h-[calc(100vh-56px-var(--proto-cbar,50px))] font-admin-body leading-[1.2] ${
        panel ? "grid-cols-[1fr_380px]" : "grid-cols-[1fr]"
      }`}
    >
      <div className={`flex min-w-0 flex-col gap-[12px] px-[28px] py-[20px] ${panel ? "border-r border-admin-border" : ""}`}>
        ...
        <div className="flex items-center justify-between gap-[12px]">
          <div>
            ...
            <p className="m-0 mt-[4px] text-admin-13 leading-[1.2] text-admin-ink-muted">{t(`${B}.subtitle.${view}`)}</p>
          </div>
        ...
        <div className="flex gap-[2px] border-b border-admin-border" role="tablist">
          {APPOINTMENT_VIEWS.map((id) => (
            <button
              ...
              className={`-mb-px cursor-pointer border-b-2 px-[12px] py-[10px] font-admin-body text-admin-13 leading-[1.2] ${
