  ...
  return (
    <div className="flex flex-col gap-[14px]" data-testid="events-panel-tickets">
      ...
      <div className="grid grid-cols-4 gap-[12px] max-[720px]:grid-cols-3 max-[720px]:gap-[8px]">
        ...
        {stat(t("dashboard.events.tickets.remaining"), figures?.remaining === null || figures === null ? null : `${figures.unknownPools > 0 ? "≤ " : ""}${figures.remaining}`, sessionId ? (figures && figures.unknownPools > 0 ? interpolate(t("dashboard.events.tickets.soldPartialNote"), { n: figures.unknownPools }) : t("dashboard.events.tickets.remainingNote")) : noNight, "events-stat-remaining")}
