...
// ════════════════════════════════════════════════════════════════════
// drawer-switch.tsx — the switch over every drawer body, loaded on demand.
//
// Split out of drawers.tsx (the Phase 1d THIN BARREL) so that `DrawerRoot`
// can reach these 118 bodies through `next/dynamic`. Everything below the
// banner is drawers.tsx's former content, byte-for-byte, minus DrawerRoot.
//
...
export function DrawerSwitch({ id }: { id: DrawerId }) {
  switch (id) {
    case "tenant-summary":
