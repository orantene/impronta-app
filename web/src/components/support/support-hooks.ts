...
export function useSupportSessionRestore(): {
  view: "home" | "tickets" | "thread" | "new" | "idea" | "guide";
  ticketId: string | null;
  setView: (v: "home" | "tickets" | "thread" | "new" | "idea" | "guide", ticketId?: string | null) => void;
  restoredRef: { current: boolean };
} {
  const [view, setViewState] = useState<"home" | "tickets" | "thread" | "new" | "idea" | "guide">("home");
  ...
  useEffect(() => {
    try {
      ...
      if (parsed.view === "home" || parsed.view === "tickets" || parsed.view === "thread" || parsed.view === "new" || parsed.view === "idea" || parsed.view === "guide") {
  ...
  const setView = useCallback((v: "home" | "tickets" | "thread" | "new" | "idea" | "guide", id?: string | null) => {
