...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    approach: [
      ...
      "Collects the deposit and e-signature in the same thread, no separate invoice tool needed",
  ...
  },
  {
    ...
    cardSummary:
      "A culinary hub lists private chefs by cuisine and party size, so guests browse menus and book a dinner in minutes.",
    challenge:
  ...
  },
  {
    ...
    challenge:
      "Luxury-rental managers juggled a dozen vendors per property. One bad link in the chain ruined a guest's stay, and the review along with it.",
    approach: [
...
const CASE_STUDIES_ES: Record<string, LocalizedStudy> = {
  ...
  tattoo: {
    ...
    cardSummary:
      "Iván cambió una lista de espera caótica en DMs por un flujo de reservas con depósito, así solo los clientes en serio consiguen lugar.",
    challenge:
  ...
  chefs: {
    ...
    cardSummary:
      "Un hub culinario lista chefs privados por cocina y tamaño de grupo, así los invitados ven menús y reservan una cena en minutos.",
    challenge:
  ...
  villa: {
    ...
    challenge:
      "Los administradores de rentas de lujo hacían malabares con una docena de proveedores por propiedad. Un solo eslabón flojo arruinaba la estancia de un huésped, y la reseña junto con ella.",
    approach: [
