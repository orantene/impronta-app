...
export function buildClientCopy(t: Translator) {
  return {
    ...
    pay: {
      ...
      total: t("dashboard.messagesV5.client.link.pay.total"),
      paidAmount: t("dashboard.messagesV5.client.link.pay.paidAmount"),
      ...
      methodTransfer: t("dashboard.messagesV5.client.link.pay.methodTransfer"),
