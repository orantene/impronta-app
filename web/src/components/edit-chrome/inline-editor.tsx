...
import { MediaPickerDialog, type MediaPickedItem } from "./media-picker-dialog";
  ...
  return (
    <>
      ...
      <MediaPickerDialog
        ...
        // see D1 fix above). `onPick` still fires on every pick — the drawer
        // calls both unconditionally — so it must stay a no-op to avoid a
