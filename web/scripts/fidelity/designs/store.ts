...
const PHOTO = {
  print: fidelityPhotoSrc("vocalistPortrait"),
  altA: fidelityPhotoSrc("studioScene"),
  altB: fidelityPhotoSrc("serviceProsScene"),
  altC: fidelityPhotoSrc("directorPortrait"),
  relA: fidelityPhotoSrc("studioDesk"),
  relB: fidelityPhotoSrc("studioScene"),
  relC: fidelityPhotoSrc("serviceProsScene"),
};
...
export const storeDesign: FidelityDesign = {
  id: "store",
