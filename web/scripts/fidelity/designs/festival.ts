...
const PHOTO = {
  hero: fidelityPhotoSrc("studioScene"),
  cinematic: fidelityPhotoSrc("serviceProsScene"),
  pA: fidelityPhotoSrc("vocalistPortrait"),
  pB: fidelityPhotoSrc("directorPortrait"),
  pC: fidelityPhotoSrc("serviceProsScene"),
  pD: fidelityPhotoSrc("studioDesk"),
};
...
export const festivalDesign: FidelityDesign = {
  id: "festival",
