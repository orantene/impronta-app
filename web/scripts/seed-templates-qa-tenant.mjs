/**
 * Provision the Templates & Imagery QA workspace (a BUSINESS tenant owned by
 * qa-admin@impronta.test) for composer live checks. Derived from
 * seed-qa-admin-second-workspace.mjs; nothing here touches a real tenant.
 ...
 *
 * Run from web/:
 *   node --env-file=.env.local scripts/seed-templates-qa-tenant.mjs
 *
...
const WORKSPACE_SLUG        = process.env.TPL_QA_SLUG || "tpl-qa-studio";
const WORKSPACE_DISPLAY_NAME = process.env.TPL_QA_NAME || "Templates QA Studio";
