...
4. `web/docs/admin-prototype/DRAWERS.md` — 149 drawer reference (~30m skim)
5. `_help.tsx` registry top — `HelpEntry` shape (5m)

### 6.2 Decision log
A `DECISIONS.md` file should be created next to this roadmap at `web/docs/admin-prototype/DECISIONS.md` capturing:
