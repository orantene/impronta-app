...
| 7 | **`exec-p7a-4-roundtrip` / `p7a-4-cache`** | Publish + reopen truth | Automated slices in `p7a-reorder-publish-parity.test.ts` (nested reorder, **`blank_section`**, **cross-`blank_section` move**); human **7A Reality Test** still authoritative | Evidence doc |
