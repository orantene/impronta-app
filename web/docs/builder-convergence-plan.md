...
| B.2.B — EditShell wiring (shell sections selectable on canvas) | not started | | | | EditProvider loads shell draft alongside page draft; selection layer detects shell sections; inspector binds to shell row's draft; save→publish round trip. |
