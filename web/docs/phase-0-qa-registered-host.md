...
| High | BUG-005 — Publish / “saved” trust when canvas still wrong (preflight + copy slices landed; full loop human-gated) | Web | [Human QA run](./builder-human-qa-run-2026-05-09.md) · `topbar` SaveStatus + viewport tooltips (2026-05-14) |
...
| Medium | BUG-007 — Add-section library density for first-time users | Web | [Human QA run](./builder-human-qa-run-2026-05-09.md) · partial: optional-filters disclosure + [`element-library-insert-picker`](../src/components/edit-chrome/element-library-insert-picker.tsx) clear search |
