 ...
 *   web/src/components/admin/shell/internal/field-catalog.ts (FIELD_CATALOG hardcoded)
 *   web/src/components/admin/shell/internal/state.tsx         (TAXONOMY_FIELDS)
 *
 * Emits SQL to stdout:
 ...
 *     > supabase/migrations/20260901120400_seed_profile_field_catalog.sql
 *
 * Re-run when the admin shell catalog changes. Idempotent via ON CONFLICT
...
lines.push("-- Source of truth: web/src/components/admin/shell/internal/field-catalog.ts");
lines.push("--                  web/src/components/admin/shell/internal/state.tsx (TAXONOMY_FIELDS)");
