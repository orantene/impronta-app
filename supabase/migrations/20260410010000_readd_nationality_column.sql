BEGIN;
-- ---------------------------------------------------------------------------
-- Re-add nationality as a canonical TEXT column on talent_profiles.
-- (Was dropped in 20260410000000 but is required by the registration flow.)
-- ---------------------------------------------------------------------------
ALTER TABLE public.talent_profiles
  ADD COLUMN IF NOT EXISTS nationality TEXT;
-- ---------------------------------------------------------------------------
-- Replace onboarding RPC — adds p_nationality back.
-- Drops all historical overloads first to avoid PostgREST ambiguity.
-- ---------------------------------------------------------------------------
