...
DROP POLICY IF EXISTS "cms_pages_staff_read" ON public.cms_pages;
CREATE POLICY "cms_pages_staff_read" ON public.cms_pages
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_pages_active_staff_write" ON public.cms_pages;
...
DROP POLICY IF EXISTS "cms_page_sections_staff_read" ON public.cms_page_sections;
CREATE POLICY "cms_page_sections_staff_read" ON public.cms_page_sections
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_page_sections_active_staff_write" ON public.cms_page_sections;
...
DROP POLICY IF EXISTS "cms_page_revisions_staff_read" ON public.cms_page_revisions;
CREATE POLICY "cms_page_revisions_staff_read" ON public.cms_page_revisions
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_page_revisions_active_staff_write" ON public.cms_page_revisions;
...
DROP POLICY IF EXISTS "cms_sections_staff_read" ON public.cms_sections;
CREATE POLICY "cms_sections_staff_read" ON public.cms_sections
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_sections_active_staff_write" ON public.cms_sections;
...
DROP POLICY IF EXISTS "cms_section_comments_staff_read" ON public.cms_section_comments;
CREATE POLICY "cms_section_comments_staff_read" ON public.cms_section_comments
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_section_comments_active_staff_write" ON public.cms_section_comments;
...
CREATE POLICY "cms_builder_components_staff_read" ON public.cms_builder_components
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_builder_components_active_staff_write" ON public.cms_builder_components;
...
DROP POLICY IF EXISTS "cms_workspace_templates_staff_read" ON public.cms_workspace_templates;
CREATE POLICY "cms_workspace_templates_staff_read" ON public.cms_workspace_templates
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_workspace_templates_active_staff_write" ON public.cms_workspace_templates;
...
DROP POLICY IF EXISTS "cms_navigation_menus_staff_read" ON public.cms_navigation_menus;
CREATE POLICY "cms_navigation_menus_staff_read" ON public.cms_navigation_menus
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_navigation_menus_active_staff_write" ON public.cms_navigation_menus;
...
DROP POLICY IF EXISTS "cms_navigation_items_staff_read" ON public.cms_navigation_items;
CREATE POLICY "cms_navigation_items_staff_read" ON public.cms_navigation_items
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_navigation_items_active_staff_write" ON public.cms_navigation_items;
...
DROP POLICY IF EXISTS "cms_posts_staff_read" ON public.cms_posts;
CREATE POLICY "cms_posts_staff_read" ON public.cms_posts
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_posts_active_staff_write" ON public.cms_posts;
...
DROP POLICY IF EXISTS "cms_post_revisions_staff_read" ON public.cms_post_revisions;
CREATE POLICY "cms_post_revisions_staff_read" ON public.cms_post_revisions
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_post_revisions_active_staff_write" ON public.cms_post_revisions;
...
DROP POLICY IF EXISTS "cms_redirects_staff_read" ON public.cms_redirects;
CREATE POLICY "cms_redirects_staff_read" ON public.cms_redirects
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "cms_redirects_active_staff_write" ON public.cms_redirects;
...
DROP POLICY IF EXISTS "agency_branding_staff_read" ON public.agency_branding;
CREATE POLICY "agency_branding_staff_read" ON public.agency_branding
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "agency_branding_active_staff_write" ON public.agency_branding;
...
DROP POLICY IF EXISTS "directory_filter_panel_items_staff_read" ON public.directory_filter_panel_items;
CREATE POLICY "directory_filter_panel_items_staff_read" ON public.directory_filter_panel_items
  FOR SELECT USING (public.is_staff_of_tenant(tenant_id));
DROP POLICY IF EXISTS "directory_filter_panel_items_active_staff_write" ON public.directory_filter_panel_items;
