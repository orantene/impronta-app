BEGIN;
-- Align with complete_client_onboarding: users may still be account_status `registered`
-- (legacy rows or edge cases). The app routes both registered and onboarding to role setup.
