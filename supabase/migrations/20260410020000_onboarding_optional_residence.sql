BEGIN;
-- Make residence optional during onboarding so talent can complete it later.
...
BEGIN
  ...
  -- Resolve residence only when country ISO2 is provided
  ...
  -- Resolve origin only when provided
